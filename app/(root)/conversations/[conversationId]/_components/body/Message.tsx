    ...
    <div className={cn("flex items-end",{
        ...
        <div className={cn("flex flex-col w-full mx-2", {
            ...
            <div className={cn("px-4 py-2 rounded-lg max-w[70%]", {
                ...
                {type === "text" ? <p className='text-wrap break-words whitespace-pre-wrap break-all'>{content}</p> : type === 'images' ? <div className='flex flex-col justify-center items-center gap-2'>
                    {content.map(image => {
